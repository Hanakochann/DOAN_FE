...
public class SearchResultRoommateActivity extends AppCompatActivity {
    private static String URL_SEARCH = ip_config + "/search_roommate.php";
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_result_roommate);
        ...
        SearchResultRoommateActivity.this.setTitle("Kết quả");
    ...
    private void collectDataRoommate() {
        final String city = getIntent().getExtras().getString("city_roommate");
        final String district = getIntent().getExtras().getString("district_roommate");
        final String ward = getIntent().getExtras().getString("ward_roommate");
    ...
    private void setupRecyclerViewRoommate(ArrayList<Room> lstRoom) {
        RecyclerViewAdapterSearch_Roommate myAdapter = new RecyclerViewAdapterSearch_Roommate(this, lstRoom);
