...
public class DetailHistoryRoommateActivity extends AppCompatActivity {

    private static final String TAG = DetailHistoryRoommateActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_history_roommate);
