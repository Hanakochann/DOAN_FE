...
public class DetailRoommateResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_roommate_result);
        ...
        btn_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(getUsername.equals(username)){
                    Toast.makeText(DetailRoommateResultActivity.this, "Ôi, bạn không thể gọi cho chính mình!", Toast.LENGTH_SHORT).show();
                }else {
        ...
        btn_view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(DetailRoommateResultActivity.this);
    ...
    private void getPhonenumber() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PHONE + "?username=" + username,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(DetailRoommateResultActivity.this, "Không thể hiển thị chi tiết!" + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DetailRoommateResultActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DetailRoommateResultActivity.this);
