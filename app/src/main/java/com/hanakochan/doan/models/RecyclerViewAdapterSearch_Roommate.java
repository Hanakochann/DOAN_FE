...
import com.hanakochan.doan.activities.DetailRoommateResultActivity;

import java.util.ArrayList;
import java.util.List;

public class RecyclerViewAdapterSearch_Roommate extends RecyclerView.Adapter<RecyclerViewAdapterSearch_Roommate.MyViewHolder> {
    RequestOptions options;
    private Context mcontext;
    private List<Room> mData_roommate = new ArrayList<>();

    public RecyclerViewAdapterSearch_Roommate(Context mcontext, List<Room> mData_roommate) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterSearch_Roommate.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater = LayoutInflater.from(mcontext);
        view = inflater.inflate(R.layout.listview_search_roommate_layout, parent, false);
        final RecyclerViewAdapterSearch_Roommate.MyViewHolder myViewHolder = new RecyclerViewAdapterSearch_Roommate.MyViewHolder(view);
        myViewHolder.roommate_view_container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mcontext, DetailRoommateResultActivity.class);
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterSearch_Roommate.MyViewHolder holder, int position) {
