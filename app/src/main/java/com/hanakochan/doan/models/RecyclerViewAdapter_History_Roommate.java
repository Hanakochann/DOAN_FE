...
import com.hanakochan.doan.activities.DetailHistoryRoommateActivity;
...
public class RecyclerViewAdapter_History_Roommate extends RecyclerView.Adapter<RecyclerViewAdapter_History_Roommate.MyViewHolder> {
    ...
    public RecyclerViewAdapter_History_Roommate(Context mcontext, List<Room> mData_roommate) {
    ...
    @NonNull
    @Override
    public RecyclerViewAdapter_History_Roommate.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater = LayoutInflater.from(mcontext);
        view = inflater.inflate(R.layout.listview_history_roommate_layout, parent, false);
        final RecyclerViewAdapter_History_Roommate.MyViewHolder myViewHolder = new RecyclerViewAdapter_History_Roommate.MyViewHolder(view);
        myViewHolder.roommate_view_container.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mcontext, DetailHistoryRoommateActivity.class);
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapter_History_Roommate.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            roommate_view_container = itemView.findViewById(R.id.history_roommate_container);
            roommate_tv_username = itemView.findViewById(R.id.history_roommate_tvTitle);
            roommate_tv_price = itemView.findViewById(R.id.history_roommate_tvPrice);
            roommate_tv_address = itemView.findViewById(R.id.history_roommate_tvaddress);
            roommate_tv_gender_roommate = itemView.findViewById(R.id.history_roommate_tvgender);
            roommate_tv_id = itemView.findViewById(R.id.history_roommate_tvid);
            roommate_imageView = itemView.findViewById(R.id.history_roommate_imgView);
