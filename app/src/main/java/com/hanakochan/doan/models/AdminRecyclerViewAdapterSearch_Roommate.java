...
public class AdminRecyclerViewAdapterSearch_Roommate extends RecyclerView.Adapter<AdminRecyclerViewAdapterSearch_Roommate.MyViewHolder> {
    ...
    public AdminRecyclerViewAdapterSearch_Roommate(Context mcontext, List<Room> mData_roommate) {
    ...
    @NonNull
    @Override
    public AdminRecyclerViewAdapterSearch_Roommate.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater inflater = LayoutInflater.from(mcontext);
        view = inflater.inflate(R.layout.listview_admin_search_roommate_layout, parent, false);
        final AdminRecyclerViewAdapterSearch_Roommate.MyViewHolder myViewHolder = new AdminRecyclerViewAdapterSearch_Roommate.MyViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull AdminRecyclerViewAdapterSearch_Roommate.MyViewHolder holder, int position) {
